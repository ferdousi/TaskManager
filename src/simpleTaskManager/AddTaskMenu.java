...
public class AddTaskMenu extends javax.swing.JFrame {
   ...
   final private TaskListManager taskManager;
	...
	public AddTaskMenu(TaskListManager taskManager) {
   ...
   private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
      if (taskNameTextField.getText().equals("")) 
         ...
         try {
            taskManager.addTask(new Task(taskNameTextField.getText(), TaskStatus.values()[statusComboBox.getSelectedIndex()]));
            new TaskListDisplayMenu(taskManager).setVisible(true);
            this.dispose();
         } catch (AddTaskException ex) {
            JOptionPane.showMessageDialog(this, "You must enter a unique task name");
         }
      }
